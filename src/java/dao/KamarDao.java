...
//decimal : getDouble()
        ...
        public Kamar getRecordById(String id_kamar, String nama_ruang){
            Kamar model = new Kamar();
            String sqlSearch = "select * from kamar where id_kamar=? AND nama_ruang=?";
            try {
                preSmt = koneksi.prepareStatement(sqlSearch);
                preSmt.setString(1, id_kamar);
                preSmt.setString(2, nama_ruang);
                rs = preSmt.executeQuery();
                if (rs.next()){
                    model.setIdKamar(rs.getString("id_kamar"));
                    model.setNamaRuang(rs.getString("nama_ruang"));
...
//
        ...
        public void hapusData(String id_kamar, String nama_ruang){
            ...
            try{
                ...
                preSmt.setString(2, nama_ruang);
                preSmt.executeUpdate();
                System.out.println("success delete data, id : "+id_kamar);
            }
            catch(SQLException e){
